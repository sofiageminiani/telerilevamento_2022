# richiamo la libreria che mi servirà
library(raster) 
# install.packages("rgdal") perchè come Mac user mi veniva richiesto di scaricare questo pacchetto per visualizzare le immagini in estensione.jpg
# la libreria rgdal non è da richiamare perchè fa parte di raster
# install.packages("RStoolbox)
# install.packages(“rasterdiv”)
library(RStoolbox)
library(rasterdiv)

setwd("/Users/sofiageminiani/desktop/lab") #settiamo la cartella di lavoro, Mac users

# importare/caricare l'immagine satellitare da analizzare nominandola l1992
l1992 <- brick("defor1_.jpg")
l1992 # cliccando invio otterrò una serie di informazioni riportate nei commenti sottostanti
## class      : RasterBrick 
...
# dalle informazioni possiamo trarre che abbiamo a disposizione tre bande, che la risoluzione è di tipo immagine perchè non è georeferenziata e le bande si chiamano defor1_.1, defor1_.2 e defor1_.3 
# riguardo i valori massimi e minimi vediamo che i valori vanno da 0 a 255, usiamo Shannon
...
# importare/caricare la seconda immagine satellitare da analizzare nominandola l2006
l2006 <- brick(“defor2_.jpg”)
l2006 # se clicco invio otterrò le informazioni riportate di seguito
## class      : RasterBrick 
...
dvi1992 # se clicco invio otterrò le informazioni riportate di seguito
## class      : RasterLayer 
...
# il fiume è giallo per la presenza di sedimenti al suo interno

# calcoliamo il DVI, la salute della vegetazione, per l'anno 2006
dvi2006 = l2006[[1]] - l2006[[2]]
# oppure
dvi2006 = l2006$defor2_.1 - l2006$defor2_.2
dvi2006 # se clicco invio otterrò le informazioni riportate di seguito
## class      : RasterLayer 
...
# visualizzo una immagine in cui il rosso rappresenta uan differenza alta, altissima deforestazione
